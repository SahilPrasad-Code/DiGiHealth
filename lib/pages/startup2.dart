...
class _StartupPageState extends State<StartupPage2> {
      ...
      elevation: 0,
        actions: [
          Padding(
            ...
            child: TextButton(
                onPressed: () {
                   Navigator.push(context, MaterialPageRoute(builder: (context) =>StartupPage3()),
                   );
                },
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  'Make Your Self Digital By Takeing \n Appointment Digitally',
